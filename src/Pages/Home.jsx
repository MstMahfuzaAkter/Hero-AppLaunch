    ...
    return (
        <>
            ...
            <div className='text-center flex flex-col justify-center items-center max-w-screen-xl mx-auto '>
                <h1 className='font-bold text-3xl lg:text-5xl mt-8'>We Build <br /> <span className='text-violet-500'>Productive </span><span className='text-violet-950'>Apps</span></h1>
            ...
            <div className="bg-gradient-to-tr from-[#632EE3] to-[#9F62F2] py-8 text-white text-center">
                <h1 className='text-[20px] lg:text-[40px] font-semibold'>Trusted by Millions, Built for You</h1>
